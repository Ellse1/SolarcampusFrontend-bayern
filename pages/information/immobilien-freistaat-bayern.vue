<template>
  <div class="container mt-5">
    <h3>Informationen zu Immobilien Freistaat Bayern</h3>
    <div>
      <p>
        ...
        seien und sie sich auf diese Verträge nicht bewerben werden, wurden die Dachflächen mit genau diesen Verträgen ausgeschrieben.
        Deshalb verwundert es nicht, dass es auf die wenigen Ausschreibungen der letzten Jahre kaum Bewerbungen von Investoren gab.
        In einem Telefonat mit Immobilien Freistaat Bayern wurde sich über die wenige Resonanz aus der Wirtschaft gewundert.
      </p>
      <p>
        Aktuell werden diese Verträge überarbeitet. Sie sollen nun investorenfreundlicher werden, sodass damit hoffentlich bald Pachtverträge mit z.B.
        Energiegenossenschaften geschlossen werden können. Diese Verträge gelten dann für alle Gebäude des Freistaats Bayern.
        Ein Investor kann auch ohne Ausschreibung einer bestimmten Dachfläche Interesse bei der jeweiligen Regionalverwaltung von Immobilien Freistaat Bayern Interesse bekunden.
